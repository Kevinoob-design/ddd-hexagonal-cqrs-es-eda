...
export namespace todo {
    ...
    export class CompleteTodoErrorResponse extends pb_1.Message {
        ...
        get error() {
            const cases: {
                [index: number]: "none" | "unauthorizedError" | "systemUnavailableError" | "todoDoesNotExistError" | "todoAlreadyCompletedError";
            } = {
                0: "none",
                1: "unauthorizedError",
                2: "systemUnavailableError",
                3: "todoDoesNotExistError",
                4: "todoAlreadyCompletedError"
            };
            return cases[pb_1.Message.computeOneofCase(this, [1, 2, 3, 4])];
        }
        static fromObject(data: {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_todoAlreadyCompletedError)
                writer.writeMessage(4, this.todoAlreadyCompletedError, () => this.todoAlreadyCompletedError.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class UncompleteTodoErrorResponse extends pb_1.Message {
        ...
        get error() {
            const cases: {
                [index: number]: "none" | "unauthorizedError" | "systemUnavailableError" | "todoDoesNotExistError" | "todoAlreadyUncompletedError";
            } = {
                0: "none",
                1: "unauthorizedError",
                2: "systemUnavailableError",
                3: "todoDoesNotExistError",
                4: "todoAlreadyUncompletedError"
            };
            return cases[pb_1.Message.computeOneofCase(this, [1, 2, 3, 4])];
        }
        static fromObject(data: {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_todoAlreadyUncompletedError)
                writer.writeMessage(4, this.todoAlreadyUncompletedError, () => this.todoAlreadyUncompletedError.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class DeleteTodoErrorResponse extends pb_1.Message {
        ...
        get error() {
            const cases: {
                [index: number]: "none" | "unauthorizedError" | "systemUnavailableError" | "todoDoesNotExistError";
            } = {
                0: "none",
                1: "unauthorizedError",
                2: "systemUnavailableError",
