...
/**
 * optional ErrorResponse titleOutOfBoundsError = 2;
 * @return {?proto.todo.ErrorResponse}
 */
...
/**
 * optional ErrorResponse unexpectedError = 3;
 * @return {?proto.todo.ErrorResponse}
 */
...
/**
 * optional ErrorResponse todoAlreadyCompletedError = 2;
 * @return {?proto.todo.ErrorResponse}
 */
...
proto.todo.UncompleteTodoErrorResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    todonotfounderror: (f = msg.getTodonotfounderror()) && proto.todo.ErrorResponse.toObject(includeInstance, f),
    todoalreadyuncompletederror: (f = msg.getTodoalreadyuncompletederror()) && proto.todo.ErrorResponse.toObject(includeInstance, f),
    unexpectederror: (f = msg.getUnexpectederror()) && proto.todo.ErrorResponse.toObject(includeInstance, f)
  };
...
proto.todo.UncompleteTodoErrorResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = new proto.todo.ErrorResponse;
      reader.readMessage(value,proto.todo.ErrorResponse.deserializeBinaryFromReader);
      msg.setTodoalreadyuncompletederror(value);
      break;
    case 3:
      var value = new proto.todo.ErrorResponse;
      reader.readMessage(value,proto.todo.ErrorResponse.deserializeBinaryFromReader);
...
proto.todo.UncompleteTodoErrorResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTodoalreadyuncompletederror();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
 ...
 * @return {?proto.todo.ErrorResponse}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.getTodonotfounderror = function() {
  return /** @type{?proto.todo.ErrorResponse} */ (
    jspb.Message.getWrapperField(this, proto.todo.ErrorResponse, 1));
};
...
*/
proto.todo.UncompleteTodoErrorResponse.prototype.setTodonotfounderror = function(value) {
 ...
 * @return {!proto.todo.UncompleteTodoErrorResponse} returns this
 */
proto.todo.UncompleteTodoErrorResponse.prototype.clearTodonotfounderror = function() {
  return this.setTodonotfounderror(undefined);
};
 ...
 * @return {boolean}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.hasTodonotfounderror = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional ErrorResponse todoAlreadyUncompletedError = 2;
 * @return {?proto.todo.ErrorResponse}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.getTodoalreadyuncompletederror = function() {
  return /** @type{?proto.todo.ErrorResponse} */ (
    jspb.Message.getWrapperField(this, proto.todo.ErrorResponse, 2));
};
 ...
 * @return {!proto.todo.UncompleteTodoErrorResponse} returns this
*/
proto.todo.UncompleteTodoErrorResponse.prototype.setTodoalreadyuncompletederror = function(value) {
 ...
 * @return {!proto.todo.UncompleteTodoErrorResponse} returns this
 */
proto.todo.UncompleteTodoErrorResponse.prototype.clearTodoalreadyuncompletederror = function() {
  return this.setTodoalreadyuncompletederror(undefined);
};
 ...
 * @return {boolean}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.hasTodoalreadyuncompletederror = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {?proto.todo.ErrorResponse}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.getUnexpectederror = function() {
  return /** @type{?proto.todo.ErrorResponse} */ (
    jspb.Message.getWrapperField(this, proto.todo.ErrorResponse, 3));
};
 ...
 * @return {!proto.todo.UncompleteTodoErrorResponse} returns this
*/
proto.todo.UncompleteTodoErrorResponse.prototype.setUnexpectederror = function(value) {
 ...
 * @return {!proto.todo.UncompleteTodoErrorResponse} returns this
 */
proto.todo.UncompleteTodoErrorResponse.prototype.clearUnexpectederror = function() {
  return this.setUnexpectederror(undefined);
};
 ...
 * @return {boolean}
 */
proto.todo.UncompleteTodoErrorResponse.prototype.hasUnexpectederror = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @const
 */
proto.todo.DeleteTodoErrorResponse.oneofGroups_ = [[1,2]];
 ...
 * @return {?proto.todo.ErrorResponse}
 */
proto.todo.DeleteTodoErrorResponse.prototype.getTodonotfounderror = function() {
  return /** @type{?proto.todo.ErrorResponse} */ (
    jspb.Message.getWrapperField(this, proto.todo.ErrorResponse, 1));
};
...
*/
proto.todo.DeleteTodoErrorResponse.prototype.setTodonotfounderror = function(value) {
 ...
 * @return {!proto.todo.DeleteTodoErrorResponse} returns this
 */
proto.todo.DeleteTodoErrorResponse.prototype.clearTodonotfounderror = function() {
  return this.setTodonotfounderror(undefined);
};
 ...
 * @return {boolean}
 */
proto.todo.DeleteTodoErrorResponse.prototype.hasTodonotfounderror = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.todo.ErrorResponse}
 */
proto.todo.DeleteTodoErrorResponse.prototype.getUnexpectederror = function() {
  return /** @type{?proto.todo.ErrorResponse} */ (
    jspb.Message.getWrapperField(this, proto.todo.ErrorResponse, 2));
};
 ...
 * @return {!proto.todo.DeleteTodoErrorResponse} returns this
*/
proto.todo.DeleteTodoErrorResponse.prototype.setUnexpectederror = function(value) {
 ...
 * @return {!proto.todo.DeleteTodoErrorResponse} returns this
 */
proto.todo.DeleteTodoErrorResponse.prototype.clearUnexpectederror = function() {
  return this.setUnexpectederror(undefined);
};
 ...
 * @return {boolean}
 */
proto.todo.DeleteTodoErrorResponse.prototype.hasUnexpectederror = function() {
  return jspb.Message.getField(this, 2) != null;
};
